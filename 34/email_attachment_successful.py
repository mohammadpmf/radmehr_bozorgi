...
# ورودی پنجم، لیستی از فایل هایی که میخواهیم به ایمیل ضمیمه شوند
# ورودی ششم، سروری که ایمیل را ارسال می کند
# ورودی هفتم، شماره پورت که 465 گذاشتم ارور میداد. دیفالتش 587 هست که کار میکنه
# ورودی هشتم، یوزر نیم
# ورودی نهم، اپ پسورد.
send_mail("M محمد پورمحمدی فلاح", ['madval1369@gmail.com', 'mohammad.pfallah@gmail.com'],
        'یک ایمیل با ضمیمه', 'سلام\nاین یک ایمیل تستی است که ببینم چه طور میتوان با پایتون ایمیلی ارسال کرد که ضمیمه هم داشته باشد',
        [r'C:\Users\Mohammad\Desktop\My own students\3 Radmehr Bozorgi\34\chat1.py', r'C:\Users\Mohammad\Desktop\My own students\3 Radmehr Bozorgi\34\chat2.py', r'C:\Users\Mohammad\Desktop\My own students\3 Radmehr Bozorgi\Sessions Radmehr Bozorgi.xlsx', r'C:\Users\Mohammad\Desktop\My own students\3 Radmehr Bozorgi\a.py'],
        'smtp.gmail.com', 587, 'madval1369@gmail.com', 'rwdfntxebjstxfig')
